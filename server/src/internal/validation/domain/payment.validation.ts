/**
 * Payment-related validation utilities (server-only)
 *
 * @module ServerPaymentValidation
 * @description Server-side payment validation functions
 */
import type { BaseValidationResult } from '@shared/types';
import { sanitizeCardNumber } from '@shared/utils/infrastructure/sanitization.utils';

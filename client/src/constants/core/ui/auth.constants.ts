import { OAuthErrorType } from '@shared/constants';

import type { FeatureHighlightItem } from '@/types';

import { FeatureHighlightAccent } from './color.constants';
...
export const LOGIN_FEATURE_HIGHLIGHTS: FeatureHighlightItem[] = [
	{
		...
		icon: 'checkcircle',
		label: 'Secure Login',
		accent: FeatureHighlightAccent.GREEN,
	},
	{
		id: 'auth-track',
		icon: 'list',
		label: 'Track Progress',
		accent: FeatureHighlightAccent.BLUE,
	},
	{
		id: 'auth-sync',
		icon: 'refreshcw',
		label: 'Sync Data',
		accent: FeatureHighlightAccent.PURPLE,
	},
];

// Re-export OAuthErrorType for convenience
export { OAuthErrorType };

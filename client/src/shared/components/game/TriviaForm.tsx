...
import CustomDifficultySuggestions from '../stats/CustomDifficultySuggestions';
import GameModeSelection from '../game-mode/GameMode';
import { 
  isCustomDifficulty as isCustomDifficultyUtil, 
  extractCustomDifficultyText, 
  createCustomDifficulty,
  validateCustomDifficultyTextEnhanced as validateCustomDifficultyText 

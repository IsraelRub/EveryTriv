...
import { LoadingPayload, ErrorPayload } from '../../types/redux';
...
export const { setLoading, setError, clearError, setFavorites, addFavorite, removeFavorite, clearFavorites, reset } =

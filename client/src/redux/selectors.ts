...
export const selectUserPointBalance = createSelector([selectUser], user => user.pointBalance);
...
export const selectGameData = createSelector([selectGame], game => game.data);
...
export const selectGameScore = createSelector([selectGameData], data => data?.score || 0);
...
// Stats selectors
export const selectUserStats = createSelector([selectStats], stats => stats.stats);

export const selectLeaderboard = createSelector([selectStats], stats => stats.leaderboard);
...
export const selectIsGameLoading = createSelector([selectGame], game => game.isLoading);

export const selectIsStatsLoading = createSelector([selectStats], stats => stats.isLoading);
...
export const selectStatsError = createSelector([selectStats], stats => stats.error);

export const selectFavoritesError = createSelector([selectFavorites], favorites => favorites.error);

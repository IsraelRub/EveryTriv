...
import { useGoogleOAuth } from '../../hooks/api/useAccountManagement';
...
export default function LoginView() {
	...
	return (
		<Container size='xl' className='min-h-screen flex flex-col items-center justify-center p-4'>
			<Section padding='xl' className='w-full max-w-md'>
				{/* Header */}
				<motion.div 
					variants={fadeInUp} 
					initial="hidden" 

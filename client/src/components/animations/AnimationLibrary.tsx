...
import { ANIMATION_CONFIG, ACCESSIBILITY_CONFIG } from '../../constants/ui/animation.constants';
...
export const createStaggerContainer = (delay: number = ANIMATION_CONFIG.STAGGER.NORMAL): Variants => ({
	hidden: { opacity: 0 },
	visible: {
		opacity: 1,
		transition: {

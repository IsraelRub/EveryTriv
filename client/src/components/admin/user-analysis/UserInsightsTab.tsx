...
import { AchievementCardSkeleton } from '@/components/statistics';
					...
					<Card>
						...
						<CardContent>
							<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
								{[...Array(3)].map((_, i) => (
									<AchievementCardSkeleton key={i} variant={AchievementCardVariant.DETAILED} />
								))}
							</div>
						</CardContent>
					</Card>
					...
					<CardHeader>
						<div className='flex items-center justify-between'>
							<div>
								<CardTitle>Achievements</CardTitle>
								<CardDescription>
									User achievements and milestones • Total Points:{' '}
									<span className='font-semibold text-primary'>
										{calculateTotalAchievementPoints(userAchievements.data)}
									</span>
								</CardDescription>
							</div>
						</div>
						...
						<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
							{userAchievements.data.map(achievement => (
								<AchievementCard
									...
									variant={AchievementCardVariant.DETAILED}

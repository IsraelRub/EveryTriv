...
import { SKELETON_HEIGHTS, SKELETON_WIDTHS, VariantBase } from '@/constants';
...
import { formatDateTime, formatPlayTime } from '@/utils';
						...
						<div key={index} className='flex items-start gap-3 p-3 border rounded-lg'>
							...
							<div className='flex-1'>
								<div className='flex items-center justify-between'>
									...
									<span className='text-sm text-muted-foreground'>{formatDateTime(activity.date)}</span>
								</div>

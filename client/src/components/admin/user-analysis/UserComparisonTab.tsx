import { Flame, GamepadIcon, Target, TrendingUp } from 'lucide-react';
		...
		<div className='space-y-6'>
			<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
				<StatCard
					...
					trend={`${formatForDisplay(comparisonData.differences.successRate ?? 0, 1)}%`}
				...
				<StatCard
					...
					trend={`${formatForDisplay(comparisonData.differences.averageScore ?? 0, 0)}`}
				...
				<StatCard
					...
					trend={`${formatForDisplay(comparisonData.differences.totalGames ?? 0, 0)}`}

...
export const UserAnalysisExpandedPanel = memo(function UserAnalysisExpandedPanel({
	...
	return (
		<div className='space-y-3 p-4 pt-0'>
			<div className={showUserAnalysisRightColumn ? 'grid grid-cols-2 gap-4' : undefined}>
				<Accordion type='multiple' defaultValue={defaultAccordionLeft} className='min-w-0 w-full'>
				...
				{showUserAnalysisRightColumn ? (
					<Accordion type='multiple' defaultValue={defaultAccordionRight} className='min-w-0 w-full'>
									...
									<div className='grid grid-cols-4 gap-4 text-sm'>
										...
										{insightsData.strengths != null && insightsData.strengths.length > 0 ? (
											<div className='rounded-lg bg-muted/50 p-4 transition-colors hover-row'>
												<div className='mb-2 flex items-center gap-2'>
													<Award
														className={cn('h-5 w-5 flex-shrink-0', SEMANTIC_ICON_TEXT.success)}
														strokeWidth={2.25}
													/>

...
import { CardGridProps, ContainerProps, GridLayoutProps, ResponsiveGridProps, SectionProps } from '../../types';
import { combineClassNames } from '../../utils/combineClassNames';

export const CardGrid: FC<CardGridProps> = ({ children, className, columns = 'auto', gap = 'lg' }) => {
...
export const LayoutContainer: FC<ContainerProps> = ({ children, className, size = 'lg', centered = true }) => {
...
export const LayoutSection: FC<SectionProps> = ({ children, className, padding = 'lg', background = 'none' }) => {
...
export const ResponsiveGrid: FC<ResponsiveGridProps> = ({ children, className, minWidth = '300px', gap = 'lg' }) => {

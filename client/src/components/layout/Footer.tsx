...
import { APP_NAME, CONTACT_INFO, NAVIGATION_LINKS, SOCIAL_LINKS } from '../../constants';
          ...
          >
            ...
            <div className='space-y-3 text-sm'>
              ...
              <div className='flex items-center text-slate-300'>
                ...
                <span>
                  Made with <Icon name='heart' size='sm' className='mx-1 text-red-400' /> for trivia
        ...
        >
          <div className='flex flex-col md:flex-row justify-center items-center space-y-2 md:space-y-0 md:space-x-6'>
            <p className='text-slate-400 text-sm'>
              © {currentYear} <span className='font-medium text-slate-300'>{APP_NAME}</span>. All
              rights reserved.
            </p>
            <div className='flex items-center space-x-4 text-xs text-slate-500'>
              ...
              <span>•</span>
              <span>
                Made with <Icon name='heart' size='xs' className='inline text-red-400' /> for trivia
                lovers
              </span>
            </div>
          </div>

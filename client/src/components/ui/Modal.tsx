			...
			>
				<div
					...
					className={combineClassNames(
						...
						// Size variants
						{
							'w-full max-w-sm': size === ModalSize.SM,
							'w-full max-w-md': size === ModalSize.MD,
							'w-full max-w-lg': size === ModalSize.LG,
							'w-full max-w-xl': size === ModalSize.XL,
							'w-screen h-screen': size === ModalSize.FULL,
						},

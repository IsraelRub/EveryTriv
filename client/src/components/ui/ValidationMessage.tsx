...
export const ValidationError: FC<Omit<ValidationMessageProps, 'status'> & { errors: string[] }> = (props) => (
	<ValidationMessage {...props} status='invalid' />
);

export const ValidationSuccess: FC<Omit<ValidationMessageProps, 'status'> & { message: string }> = ({
	message,
	...props
}) => <ValidationMessage {...props} status='valid' successMessage={message} />;

export const ValidationWarning: FC<Omit<ValidationMessageProps, 'status'> & { warnings: string[] }> = (props) => (
	<ValidationMessage {...props} status='warning' />
);

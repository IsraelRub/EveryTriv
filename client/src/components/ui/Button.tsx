      ...
      const buttonElement = (
        <button
          ...
          className={combineClassNames(
            ...
            {
              'hover:bg-gradient-to-r from-[#667eea]/30 to-[#764ba2]/30':
                variant === 'primary' && isGlassy,
              'hover:bg-gradient-to-r from-[#f093fb]/30 to-[#f5576c]/30':
                variant === 'secondary' && isGlassy,
              'hover:bg-gradient-to-r from-[#4facfe]/30 to-[#00f2fe]/30':
                variant === 'accent' && isGlassy,
            },

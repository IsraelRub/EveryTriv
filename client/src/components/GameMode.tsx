...
import { ButtonVariant, ComponentSize, DEFAULT_GAME_MODE, GAME_MODE_DEFAULTS } from '../constants';
...
export default function GameMode({ isVisible, onSelectMode, onCancel }: GameModeUIProps) {
	...
	const [timeLimit, setTimeLimit] = useState<number>(() => GAME_MODE_DEFAULTS[DEFAULT_GAME_MODE].timeLimit);

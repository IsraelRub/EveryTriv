...
const VALIDATION_MESSAGE_TO_KEY: Record<string, string> = {
	...
	[ERROR_MESSAGES.validation.UNRECOGNIZABLE_TEXT]: ErrorsKey.UNRECOGNIZABLE_TEXT,
	[ERROR_MESSAGES.game.TRIVIA_DECLINED_UNCLEAR_TOPIC]: ErrorsKey.TRIVIA_DECLINED_UNCLEAR_TOPIC,
	[ERROR_MESSAGES.game.TRIVIA_DECLINED_UNCLEAR_DIFFICULTY]: ErrorsKey.TRIVIA_DECLINED_UNCLEAR_DIFFICULTY,
	[ERROR_MESSAGES.game.TRIVIA_DECLINED_UNCLEAR_TOPIC_AND_DIFFICULTY]:
		ErrorsKey.TRIVIA_DECLINED_UNCLEAR_TOPIC_AND_DIFFICULTY,

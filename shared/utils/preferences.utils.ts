...
export function mergeWithDefaults(
	userPreferences: UserPreferences | Partial<ServerUserPreferences> | null | undefined
	...
	return {
		...
		privacy: {
			profileVisibility:
				userPreferences.privacy?.profileVisibility || DEFAULT_USER_PREFERENCES.privacy.profileVisibility,

...
> **הבחנה חשובה**: מסמך זה (Authorization - הרשאה) עוסק בשאלה **"מה אתה רשאי לעשות?"** - תפקידים, Guards, בקרת גישה, והרשאות. לשאלה **"מי אתה?"** (Authentication - אימות) - רישום, התחברות, וניהול טוקנים - ראו [AUTH.md](./features/AUTH.md).

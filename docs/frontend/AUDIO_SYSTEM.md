...
> **הערת ארגון**: תיעוד זה מדגיש היבטי יישום (טעינה, ניהול זיכרון, מבנה קבצים). היבטי UI ועיצוב משלימים מופיעים ב-[מערכת העיצוב](./DESIGN_SYSTEM.md). קבועים גלובליים (מפת מפתחות, קטגוריות) מנוהלים במקום יחיד.
